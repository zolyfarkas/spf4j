...
public final class FailOnTimeout extends Statement {
    ...
    public static final class Builder {
        ...
        public Builder withTimeout(final long timeout, final TimeUnit unit) {
            ...
            if (unit == null) {
                throw new NullPointerException("TimeUnit cannot be null for  " + timeout);
            }
    ...
    private Thread[] copyThreads(Thread[] threads, int count) {
        ...
        return Arrays.copyOf(threads, length);
    }
  ...
  public String toString() {
    return "FailOnTimeout{" + "originalStatement=" + originalStatement
            + ", timeUnit=" + timeUnit + ", timeout=" + timeout + ", lookForStuckThread="
            + lookForStuckThread + ", threadGroup=" + threadGroup + '}';
  }
