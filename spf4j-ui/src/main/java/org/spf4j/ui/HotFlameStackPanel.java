...
//public final class HotFlameStackPanel extends StackPanelBase<InvokedMethod> {
//
//  private static final long serialVersionUID = 1L;
//
//  private SampleGraph completeGraph;
//  private Map<SampleGraph.SampleVertex, Rectangle2D> methodLocations;
...
//          renderMethodLinked(g2, areaWidth, rowHeight, edges, vertex);
//        } else {
...
//
//
//      private void renderMethodLinked(final Graphics2D g2, final double areaWidth, final double rowHeight,
//              final Map<SampleNode.InvocationCount, InvokedMethod> edges,
...
//        }
//
//   Pair<List<Sampled<InvokedMethod>>, Double> result = findEmptySpace(areaWidth, newXBase, newYBase, newWidth, maxX);
//        while (!result.getFirst().isEmpty()) {
//          // TODO: optimize this to increment with a better value
//          newYBase += rowHeight;
//          result = findEmptySpace(areaWidth, newXBase, newYBase, newWidth, maxX);
//        }
//        drawMethod(g2, vertex, nrSamples, result.getSecond(), newYBase,
//                newWidth, rowHeight, fromPoints.toArray(new Point[fromPoints.size()]));
//      }
//
//      @SuppressFBWarnings("PRMC_POSSIBLY_REDUNDANT_METHOD_CALLS")
//      private Pair<List<Sampled<InvokedMethod>>, Double> findEmptySpace(final double areaWidth,
...
//        tryx = fitToViewableArea(areaWidth, tryx, newWidth);
...
//      }
//
//      private double fitToViewableArea(final double areaWidth, final double ptryx, final double newWidth) {
//        double tryx = ptryx;
//        if (tryx < 0) {
//          tryx = 0;
...
//      private void drawMethod(final Graphics2D g2, final InvokedMethod vertex, final int nrSamples,
...
//        }
//        FlameStackPanel.setElementColor(ThreadLocalRandom.current().nextInt(), g2);
