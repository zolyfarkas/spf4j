...
//import org.spf4j.stackmonitor.SampleGraph.SampleVertexKey;
...
//    Image createImage = this.createImage(WIDTH, HEIGHT);
//    return paintNode(sg, new HashMap<SampleVertex, Rectangle>(sg.getSg().nodes().size()), gr,
//            0, 0, (int) width, (int) rowHeight, wps);
//  }
//
//  SetMultimap<SampleVertexKey, SampleVertex> getUndrawedLeaves(SampleGraph sg,
//          Map<SampleGraph.SampleVertex, Rectangle> painted) {
//    SetMultimap<SampleVertexKey, SampleVertex> result = MultimapBuilder.hashKeys().hashSetValues(1).build();;
//    MutableGraph<SampleVertex> gg = sg.getSg();
//    for (SampleVertex node : gg.nodes()) {
//      if (gg.successors(node).isEmpty()) {
...
//  }
//
//  public static final class RenderedGraph {
//
//    private final Image img;
//    private final Map<SampleVertex, Integer> parentConnectors;
//    private final Map<SampleVertex, Rectangle> allVertexes;
//  }
//
//  @Nullable
//  private RenderedGraph paintOneNode(SampleVertex vtx, final double wps) {
//  }
//
...
//          final int width, final int rowHeight, final double wps) {
//
