...
public class TSDBMeasurementDatabase implements MeasurementDatabase, Closeable, TSDBMeasurementDatabaseMBean {
    ...
    private String generateCountChart(
        ...
        BufferedImage count = Charts.createTimeSeriesChartImg("Measurements for "
                + groupName + " generated by spf4j",
                timestamps, measurementNames, uom1, measurements, width, height / 2);

        BufferedImage total = Charts.createTimeSeriesChartImg(null,
    ...
    private String generateHeatChart(ColumnInfo info, Pair<long[], long[][]> data,
        ...
        BufferedImage img = Charts.createHeatChartImg("Measurements distribution for "
                + info.getGroupName() + " generated by spf4j", new String(info.getGroupMetaData(), Charsets.UTF_8), info.getColumnNames(), mData.getSecond(),
