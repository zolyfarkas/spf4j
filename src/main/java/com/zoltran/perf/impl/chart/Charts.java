...
public final class Charts {
    ...
    public static BufferedImage createMinMaxAvgCountImg(long[] timestamps, double[] min, double[] max, double[] total, double[] count, final RrdDb rrdDb, int width, int height) {
        BufferedImage bi = Charts.createMinMaxAvgImg(timestamps, min, max, total, count, rrdDb, width, height-height/3);
        BufferedImage bi2 = Charts.createCountImg(timestamps, count, rrdDb, width, height/3);
    ...
    public static BufferedImage createCountImg(long[] timestamps,  double[] count, final RrdDb rrdDb, int width, int height)
    {
    ...
    public static BufferedImage createMinMaxAvgImg(long[] timestamps, double[] min, double[] max, double[] total, double[] count, final RrdDb rrdDb, int width, int height)
    {
    ...
    public static void createHeatChart( String chartName, File file,
        ...
        JFreeChart chart = new JFreeChart(chartName + " generated by spf4j", plot);
