 ...
 * @author zoly
 */
public class NumberJsonAppender implements ObjectAppender<Number> {
  ...
  @Override
  public final void append(final Number nr, final Appendable appendTo, final ObjectAppenderSupplier appenderSupplier)
       throws IOException {
