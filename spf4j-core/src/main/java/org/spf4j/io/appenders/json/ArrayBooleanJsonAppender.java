 ...
 * @author zoly
 */
public class ArrayBooleanJsonAppender implements ObjectAppender<boolean[]> {
  ...
  @Override
  public final void append(final boolean[] iter,
  ...
  @Override
  public final void append(final boolean[] object, final Appendable appendTo) {
