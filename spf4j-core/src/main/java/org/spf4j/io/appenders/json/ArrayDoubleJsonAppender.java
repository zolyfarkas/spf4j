 ...
 * @author zoly
 */
public class ArrayDoubleJsonAppender implements ObjectAppender<double[]> {
  ...
  @Override
  public final void append(final double[] iter,
    ...
    appendTo.append('[');
    appendTo.append(Double.toString(iter[0]));
    for (int i = 1; i < l; i++) {
       appendTo.append(',');
       appendTo.append(Double.toString(iter[i]));
    }
    appendTo.append(']');
  }
  ...
  @Override
  public final void append(final double[] object, final Appendable appendTo) {
