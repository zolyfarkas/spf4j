 ...
 * 
 * this implementation is based on java.text.MessageFormat with the goal to be a faster and more
 ...
 * sub-format, and sub-format-dependent pattern rules apply. For example,
...
public final class MessageFormat extends Format {
    ...
    /**
     * Constructs a FastMessageFormat for the default
    ...
    /**
     * Constructs a FastMessageFormat for the specified locale and
     * pattern.
     * The constructor first sets the locale, then parses the pattern and
     * creates a list of sub-formats for the format elements contained in it.
     * Patterns and their interpretation are specified in the
     * <a href="#patterns">class description</a>.
     *
     * @param pattern the pattern for this message format
     ...
     */
    @SuppressFBWarnings({ "CLI_CONSTANT_LIST_INDEX", "ITC_INHERITANCE_TYPE_CHECKING", "PL_PARALLEL_LISTS" })
     ...
     * If the source is null, return an empty array. (zoltan: yuck)
     * 
     *
  ...
  public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
     ...
     * sub-formats as necessary. If <code>characterIterators</code> is null
