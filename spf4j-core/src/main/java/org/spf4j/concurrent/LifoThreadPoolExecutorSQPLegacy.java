...
public final class LifoThreadPoolExecutorSQPLegacy extends AbstractExecutorService implements LifoThreadPool {
  ...
  public LifoThreadPoolExecutorSQPLegacy(final int maxNrThreads, final String name) {
    this(name, 0, maxNrThreads, 5000, 0);
  }

  public LifoThreadPoolExecutorSQPLegacy(final String poolName, final int coreSize,
